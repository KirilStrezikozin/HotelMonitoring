...
def main():
    ...
    camera_configs = [
        ...
        # CameraConfig(
        #     camera_id=4,
        #     stream_url="rtsp://admin:tEsTgfhjkm1729@192.168.12.20:554/cam/realmonitor?channel=1&subtype=1",
        #     output_url="rtsp://mediamtx:8554/cam/reception",
        # ),
        # CameraConfig(camera_id=5, video_path="videos/trento-piazza-duomo.mp4"),
        CameraConfig(
            camera_id=6,
